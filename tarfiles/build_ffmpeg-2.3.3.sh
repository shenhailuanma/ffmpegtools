...
mkdir -p ${build_dir}
mkdir -p ${release_dir}
cp -rf yasm-1.2.0.tar.gz libaacplus-2.0.2.tar.gz 26410-800.zip faac-1.28.tar.bz2 lame-3.98.4.tar.gz opencore-amr-0.1.2.tar.gz x264-snapshot-20140803-2245.tar.bz2 ffmpeg-2.3.3.tar.bz2 ${build_dir}
...
--enable-version3 --enable-libopencore-amrnb 
    ...
    echo "########## ffmpeg2.3.3 has been installed ##########"
fi
popd
