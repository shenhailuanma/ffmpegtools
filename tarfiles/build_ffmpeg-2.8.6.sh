...
mkdir -p ${build_dir}
mkdir -p ${release_dir}
cp -rf yasm-1.2.0.tar.gz libaacplus-2.0.2.tar.gz 26410-800.zip faac-1.28.tar.bz2 lame-3.98.4.tar.gz opencore-amr-0.1.2.tar.gz x264-snapshot-20160203-2245-stable.tar.bz2 ffmpeg-2.8.6.tar.gz ${build_dir}
...
then
    echo "########## libx264 begin ##########"
    tar xf x264-snapshot-20160203-2245-stable.tar.bz2
    pushd x264-snapshot-20160203-2245-stable
...
--enable-parser=h264
    ...
    echo "########## ffmpeg2.8.6 has been installed ##########"
fi
popd
